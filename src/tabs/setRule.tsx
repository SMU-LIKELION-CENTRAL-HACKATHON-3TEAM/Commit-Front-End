  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between" }}>
      ...
      >
        ...
        >
          아래는 기본으로 제공되는 권장 규칙입니다. 직접 자신에 맞게
          수정해보세요
        </p>
        ...
        >
          <div style={{ display: "flex" }}>
            ...
            >
              ...
              >
                목표{" "}
                <span style={{ fontFamily: "Pretendard-ExtraBold" }}>
                  워라밸 :{" "}
                </span>
              </div>
              <div
        ...
        <div style={{display:'flex',justifyContent:"space-around",marginTop:'10px'}}>
          <button
            ...
            onMouseOver={(e) => e.currentTarget.style.backgroundColor = 'rgba(68, 112, 243, 1)'} onMouseOut={(e) => e.currentTarget.style.backgroundColor = "#A4BCFD"}
            onClick={() => {
